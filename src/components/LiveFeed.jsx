...
function LiveFeed({ value, watch = true }) {
  ...
  return (
    <>
      ...
      {!watch && (
        <div className='d-flex gap-3'>
          <div className="container-fluid  animate__animated animate__fadeInDown animate__delay-1s px-3 cust-border py-3 bg-light shadow-sm d-flex cust-rounded justify-content-between align-items-center">
            <div className="d-flex flex-column mb-3 mb-md-0">
              <div id='live-tag' className="h6 text-danger m-0 mb-2 d-flex align-items-center">
                <div className="circle-it me-1"></div>Live
              </div>
              <p className="h1 text-shadow m-0  text-light">AQI {value}</p>
            </div>
            ...
            <div className="d-flex animate__animated animate__flipInX animate__delay-2s justify-content-center">
              <div className="cust-rounded  cust-border bg-cust shadow-sm d-flex align-items-center px-4 py-2">
                <p className="h2 text-shadow m-0 px-2 text-light py-2">{status}</p>
              </div>
            </div>
          </div>
        </div>
